...
var _count = __webpack_require__(15);
...
var Scores = function (_React$Component) {
    ...
    function Scores() {
        ...
        return _possibleConstructorReturn(this, (Scores.__proto__ || Object.getPrototypeOf(Scores)).call(this));
    }
    ...
    _createClass(Scores, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'scores' },
                _react2.default.createElement('img', { src: 'img/apple.png', alt: '', className: 'icon' }),
                _react2.default.createElement(_count2.default, { score: score })
            );
        }
    }]);
...
var BestScores = function (_React$Component) {
    ...
    function BestScores() {
        _classCallCheck(this, BestScores);

        return _possibleConstructorReturn(this, (BestScores.__proto__ || Object.getPrototypeOf(BestScores)).call(this));
    }
...
var BestScores = function (_React$Component) {
    ...
    _createClass(BestScores, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'bestScores' },
                _react2.default.createElement('img', { src: 'img/cup.png', alt: '', className: 'icon' }),
                _react2.default.createElement(_count2.default, { score: bestScore })
            );
        }
    }]);
...
var App = function (_React$Component) {
    ...
    function App(props) {
        ...
        _this.speed = 200;
        _this.startIndex = 190;
        _this.fieldWidth = 21;
        _this.fieldHeight = 20;
        _this.cellsQuantity = _this.fieldWidth * _this.fieldHeight;
        _this.state = {
            modal: false,
            score: 0,
            bestScore: 0,
        ...
        _this.movement(_this.state.cells);
        return _this;
    }

    _createClass(App, [{
        key: 'movement',
        value: function movement(cells) {
            var _this2 = this;

            this.intervalID = setInterval(function () {
                if (!_this2.gameOverCheck(cells)) {
                    _this2.setState({
                        cells: _this2.renewal(cells)
                    });
                }
            }, this.speed);
        }
        ...
        key: 'gameOverCheck',
        value: function gameOverCheck(cells) {
            var _this3 = this;

            var cell = cells.find(function (cell) {
                return !cell.empty && cell.length == cell.lengthLeft;
            });

            var nextRight = cells.find(function (next) {
                return next.index == cell.index + 1;
            });
            var nextLeft = cells.find(function (next) {
                return next.index == cell.index - 1;
            });
            var nextUp = cells.find(function (next) {
                return next.index == cell.index - _this3.fieldWidth;
            });
            var nextDown = cells.find(function (next) {
                return next.index == cell.index + _this3.fieldWidth;
            });

            if (cell.direction == 'right' && ((cell.index + 1) % this.fieldWidth == 0 || !nextRight.empty && nextRight.length != 1) || cell.direction == 'left' && (cell.index % this.fieldWidth == 0 || !nextLeft.empty && nextLeft.length != 1) || cell.direction == 'up' && (cell.index - this.fieldWidth < 0 || !nextUp.empty && nextUp.length != 1) || cell.direction == 'down' && (cell.index + this.fieldWidth > this.cellsQuantity + 1 || !nextDown.empty && nextDown.length != 1)) {
        ...
        key: 'renewal',
        value: function renewal(cells) {
            var _this4 = this;

            var headCell = null;
            cells.forEach(function (cell, i, arr) {
                if (!cell.empty && cell.length > 1) {
                    var nextIsApple = _this4.isAppleInFront(cell, arr);
                    ...
                    if (cell.length == cell.lengthLeft) {
                        ...
                        if (!nextIsApple) {
                            _this4.closeCell(cell);
                        } else cell.length++;
                    } else if (!nextIsApple) {
                        _this4.moveCell(cell);
                    } else cell.length++;
                }
            });
        ...
        key: 'computeNextCell',
        value: function computeNextCell(previousCell) {
            if (previousCell.direction == 'right') return previousCell.index + 1;else if (previousCell.direction == 'left') return previousCell.index - 1;else if (previousCell.direction == 'up') return previousCell.index - this.fieldWidth;else if (previousCell.direction == 'down') return previousCell.index + this.fieldWidth;
        }
    }, {
        key: 'isAppleInFront',
        value: function isAppleInFront(currentCell, arr) {
            var index = this.computeNextCell(currentCell);
            return arr.find(function (cell) {
                return cell.index == index;
            }).length == 1;
        }
    }, {
        key: 'addApple',
        value: function addApple(cells, point) {
            var emptyCells = cells.slice().filter(function (obj) {
                return obj.empty == true;
            });
            var randomIndex = emptyCells[Math.floor(Math.random() * emptyCells.length)].index;
            var currentCell = cells.find(function (cell) {
                return cell.index == randomIndex;
            });
        ...
        key: 'nextCell',
        value: function nextCell(previousCell, arr) {
            var _this5 = this;

            var currentCell = arr.find(function (cell) {
                return cell.index == _this5.computeNextCell(previousCell);
            });
            if (currentCell.length == 1) {
                arr = this.addApple(arr, true);
            }
        ...
        key: 'moveCell',
        value: function moveCell(cell) {
            cell.lengthLeft--;
        }
    }, {
        key: 'closeCell',
        value: function closeCell(cell) {
            cell.direction = '';
            cell.directionSelected = false;
            cell.length = 0;
            cell.lengthLeft = 0;
        ...
        value: function createCells() {
            ...
            var cells = [];
            times(this.cellsQuantity)(function () {
                cells.push({
                    empty: true,
                    index: cells.length,
            ...
            cells.forEach(function (cell) {
                if (cell.index == _this6.startIndex || cell.index == _this6.startIndex + 1 || cell.index == _this6.startIndex + 2) {
                    cell.empty = false;
                    cell.direction = 'right';
                    cell.length = 3;
                    // cell.lengthLeft = (cell.index == this.startIndex) ? 1 : 2;
                    if (cell.index % _this6.startIndex == 0) cell.lengthLeft = 1;else if (cell.index % _this6.startIndex == 1) cell.lengthLeft = 2;else if (cell.index % _this6.startIndex == 2) cell.lengthLeft = 3;
                }
            });
        ...
        value: function restartGame() {
            ...
            setTimeout(function () {
                _this7.movement(_this7.state.cells);
            }, 0);
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'content' },
                _react2.default.createElement(_modal2.default, { score: this.state.score, bestScore: this.state.bestScore, restart: this.restartGame.bind(this), modal: this.state.modal }),
                _react2.default.createElement(
                    'div',
                    { className: 'content-align' },
                    _react2.default.createElement(_header2.default, { score: this.state.score, bestScore: this.state.bestScore }),
                    _react2.default.createElement(_main2.default, { cells: this.state.cells, modal: this.state.modal })
                )
            );
        }
    }]);
...
// module
exports.push([module.i, "body {\n  background: white;\n  margin: 0px; }\n\n#app {\n  display: table;\n  position: absolute;\n  height: 100%;\n  width: 100%; }\n\n.content {\n  display: table-cell;\n  vertical-align: middle; }\n  .content-align {\n    margin-left: auto;\n    margin-right: auto;\n    width: 575px; }\n\n.header {\n  background-color: #437c3d;\n  height: 50px;\n  border: 25px solid #437c3d; }\n\n.scores, .bestScores {\n  width: 100px;\n  height: 50px;\n  display: inline-block;\n  float: left; }\n\nimg.icon {\n  display: inline-block;\n  float: left;\n  width: 40px;\n  height: 40px;\n  margin: 5px; }\n  img.icon-small {\n    cursor: pointer;\n    display: inline-block;\n    float: right;\n    width: 30px;\n    height: 30px;\n    margin: 10px; }\n  img.icon-apple {\n    width: 25px;\n    height: 25px; }\n\n.count {\n  display: inline-block;\n  width: 40px;\n  height: 40px;\n  line-height: 40px;\n  font-size: 24px;\n  margin: 5px;\n  text-align: left; }\n\n.sound {\n  display: inline-block;\n  float: right; }\n\n.speaker {\n  display: inline-block;\n  width: 40px;\n  height: 0px;\n  border: 1px solid #e82943;\n  position: relative;\n  top: 15px;\n  left: 42px;\n  cursor: pointer;\n  transform: rotate(45deg); }\n  .speaker-on {\n    display: none; }\n\n.restart {\n  display: inline-block;\n  float: right; }\n\n.main {\n  width: 525px;\n  border: 25px solid #5a994c;\n  overflow: hidden; }\n\n.field {\n  font-size: 0px; }\n\n.cell {\n  font-size: 0px;\n  width: 25px;\n  height: 25px;\n  display: inline-block; }\n  .cell_odd {\n    background-color: #c6ef6e; }\n  .cell_even {\n    background-color: #b4d66b; }\n\n.snake {\n  background-color: #5379F1;\n  width: 40px;\n  height: 21px;\n  margin-top: 2px;\n  margin-bottom: 2px;\n  border-radius: 10px;\n  position: relative;\n  left: 0px; }\n\n.snake-right.snake-head {\n  animation: move-right 200ms ease-out forwards; }\n  .snake-right.snake-head > .faceWrapper {\n    animation: head-right 200ms ease-out forwards; }\n\n.snake-right.snake-tail {\n  animation: move-tail-right 200ms ease-out forwards; }\n\n@keyframes move-right {\n  0% {\n    width: 30px; }\n  90% {\n    width: 35px; }\n  100% {\n    width: 55px; } }\n\n@keyframes head-right {\n  0% {\n    transform: translateX(-10px); }\n  90% {\n    transform: translateX(-5px); }\n  100% {\n    transform: translateX(15px); } }\n\n@keyframes move-tail-right {\n  0% {\n    transform: translateX(0%);\n    width: 40px; }\n  100% {\n    transform: translateX(25px);\n    width: 15px; } }\n\n.snake-down {\n  transform: rotate(90deg);\n  transform-origin: 12px;\n  top: 1px; }\n  .snake-down.snake-head {\n    animation: move-down 200ms ease-out forwards; }\n    .snake-down.snake-head > .faceWrapper {\n      animation: head-down 200ms ease-out forwards; }\n  .snake-down.snake-tail {\n    width: 21px;\n    margin-left: 2px;\n    margin-right: 2px;\n    animation: move-tail-down 200ms ease-out forwards; }\n\n@keyframes move-down {\n  0% {\n    width: 30px; }\n  90% {\n    width: 35px; }\n  100% {\n    width: 55px; } }\n\n@keyframes head-down {\n  0% {\n    transform: translateX(-10px); }\n  90% {\n    transform: translateX(-5px); }\n  100% {\n    transform: translateX(15px); } }\n\n@keyframes move-tail-down {\n  0% {\n    height: 40px;\n    transform: translateY(0%); }\n  100% {\n    height: 15px;\n    transform: translateY(25px); } }\n\n.snake-left {\n  transform: rotate(180deg);\n  transform-origin: 12px; }\n  .snake-left.snake-head {\n    animation: move-left 200ms ease-out forwards; }\n    .snake-left.snake-head > .faceWrapper {\n      animation: head-left 200ms ease-out forwards; }\n  .snake-left.snake-tail {\n    animation: move-tail-left 200ms ease-out forwards; }\n\n@keyframes move-left {\n  0% {\n    width: 30px; }\n  90% {\n    width: 35px; }\n  100% {\n    width: 55px; } }\n\n@keyframes head-left {\n  0% {\n    transform: translateX(-10px); }\n  90% {\n    transform: translateX(-5px); }\n  100% {\n    transform: translateX(15px); } }\n\n@keyframes move-tail-left {\n  0% {\n    transform: translateX(-13px); }\n  100% {\n    transform: translateX(-25px);\n    width: 16px; } }\n\n.snake-up {\n  transform: rotate(-90deg);\n  transform-origin: 12px;\n  top: -1px; }\n  .snake-up.snake-head {\n    animation: move-up 200ms ease-out forwards; }\n    .snake-up.snake-head > .faceWrapper {\n      animation: head-up 200ms ease-out forwards; }\n  .snake-up.snake-tail {\n    width: 21px;\n    margin-left: 2px;\n    margin-right: 2px;\n    animation: move-tail-up 200ms ease-out forwards; }\n\n@keyframes move-up {\n  0% {\n    width: 30px; }\n  90% {\n    width: 35px; }\n  100% {\n    width: 55px; } }\n\n@keyframes head-up {\n  0% {\n    transform: translateX(-10px); }\n  90% {\n    transform: translateX(-5px); }\n  100% {\n    transform: translateX(15px); } }\n\n@keyframes move-tail-up {\n  0% {\n    transform: translateY(-19px);\n    height: 40px; }\n  100% {\n    transform: translateY(-25px);\n    height: 15px; } }\n\n.faceWrapper {\n  position: absolute;\n  width: 30px; }\n\n.eye {\n  display: inline-block;\n  background-color: #5379F1;\n  width: 14px;\n  height: 14px;\n  border-radius: 100%;\n  position: relative; }\n  .eye-left {\n    display: inline-block;\n    top: -5px;\n    left: 16px; }\n  .eye-right {\n    display: inline-block;\n    top: 10px;\n    left: 3px; }\n  .eye-white {\n    display: inline-block;\n    background-color: white;\n    width: 8px;\n    height: 8px;\n    border-radius: 100%;\n    position: relative;\n    left: 3px;\n    top: 3px; }\n  .eye-retina {\n    display: inline-block;\n    background-color: black;\n    width: 3px;\n    height: 3px;\n    position: relative;\n    top: 3px;\n    left: 5px;\n    border-radius: 100%; }\n\n.nose {\n  display: inline-block;\n  width: 2px;\n  height: 2px;\n  border-radius: 100%;\n  position: relative;\n  background-color: black; }\n  .nose-left {\n    top: 4px;\n    left: 5px; }\n  .nose-right {\n    left: 33px; }\n\n.apple {\n  width: 25px;\n  height: 25px;\n  display: inline-block; }\n\n.modal {\n  margin-left: auto;\n  margin-right: auto;\n  width: 575px;\n  display: none; }\n  .modal-show {\n    display: block; }\n  .modal-content {\n    position: absolute;\n    width: 575px;\n    height: 650px;\n    background-color: rgba(0, 0, 0, 0.3);\n    display: block;\n    text-align: center;\n    z-index: 2; }\n    .modal-content:before {\n      content: '';\n      height: 100%;\n      display: inline-block;\n      vertical-align: middle; }\n  .modal-window {\n    display: inline-block;\n    width: 400px;\n    height: 250px;\n    vertical-align: middle;\n    border-radius: 10px; }\n\n.achievement {\n  display: block;\n  background-color: #b4d66b;\n  height: 170px;\n  margin-bottom: 20px;\n  border-radius: 10px; }\n  .achievement:before {\n    content: '';\n    height: 100%;\n    display: inline-block;\n    vertical-align: middle; }\n  .achievement > .scores, .achievement > .bestScores {\n    float: none;\n    vertical-align: middle;\n    width: 120px;\n    height: 70px; }\n    .achievement > .scores > .count, .achievement > .bestScores > .count {\n      font-size: 32px; }\n\n.restart-button {\n  display: inline-block;\n  background-color: #b4d66b;\n  width: 100%;\n  height: 60px;\n  border-radius: 10px;\n  cursor: pointer;\n  border: none;\n  vertical-align: top; }\n  .restart-button-text {\n    font-size: 28px;\n    line-height: 50px;\n    display: inline-block;\n    vertical-align: top; }\n  .restart-button > .restart {\n    float: none; }\n", ""]);
...
var _scores = __webpack_require__(14);

var _scores2 = _interopRequireDefault(_scores);

var _bestScores = __webpack_require__(16);

var _bestScores2 = _interopRequireDefault(_bestScores);

var _sound = __webpack_require__(36);
    ...
    _createClass(Header, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'header' },
                _react2.default.createElement(_scores2.default, { score: score }),
                _react2.default.createElement(_bestScores2.default, { bestScore: bestScore }),
...
var Sound = function (_React$Component) {
    ...
    function Sound() {
        ...
        return _possibleConstructorReturn(this, (Sound.__proto__ || Object.getPrototypeOf(Sound)).call(this));
    }
    ...
    _createClass(Sound, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'sound', style: { display: 'none' } },
                _react2.default.createElement('img', { src: 'img/speaker.png', alt: '', className: 'icon-small' }),
    ...
    _createClass(Main, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'main' },
                _react2.default.createElement(_field2.default, { cells: cells, modal: this.props.modal })
            );
        }
    }]);
...
var Field = function (_React$Component) {
    ...
    _createClass(Field, [{
        ...
        value: function render() {
            ...
            var CellsComponents = this.props.cells.map(function (cell) {
                return _react2.default.createElement(_cell2.default, { key: cell.id, cell: cell, modal: _this2.props.modal });
            });
            return _react2.default.createElement(
                'div',
                { className: 'field' },
...
var _snake = __webpack_require__(40);

var _snake2 = _interopRequireDefault(_snake);

var _apple = __webpack_require__(41);
...
var Cell = function (_React$Component) {
    ...
    _createClass(Cell, [{
        ...
        value: function render() {
            ...
            var snake = !cell.empty && cell.length > 1 ? _react2.default.createElement(_snake2.default, { cell: cell, modal: this.props.modal }) : '';
            var apple = !cell.empty && cell.length == 1 ? _react2.default.createElement(_apple2.default, { cell: cell }) : '';
            return _react2.default.createElement(
                'div',
                { className: 'cell ' + (cell.index % 2 ? 'cell_odd' : 'cell_even') },
                snake,
                apple
            );
        }
...
var Snake = function (_React$Component) {
    ...
    function Snake() {
        ...
        _this.changeDirection = _this.changeDirection.bind(_this);
        return _this;
    }
    ...
    _createClass(Snake, [{
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "div",
                        { className: "eye-white" },
                        _react2.default.createElement("div", { className: "eye-retina" })
                    )
                ),
                _react2.default.createElement(
                    "div",
                ...
                _react2.default.createElement("div", { className: "nose nose-left" }),
                _react2.default.createElement("div", { className: "nose nose-right" })
            );
        }
    }, {
        key: "snakeClasses",
        value: function snakeClasses(cell) {
            var classes = '';
        ...
        value: function render() {
            ...
            this.cell = cell;
            var classes = this.snakeClasses(cell);
            var head = cell.length == cell.lengthLeft ? this.renderHead() : '';
            return _react2.default.createElement(
                "div",
                { className: 'snake ' + classes, style: head == '' || this.props.modal ? {} : { zIndex: 5 } },
                head
            );
        }
    }]);
    ...
    _createClass(Apple, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement("img", { className: "apple", src: "img/apple.png", alt: "icon-apple" })
            );
        }
    }]);
...
var _achievement = __webpack_require__(43);

var _achievement2 = _interopRequireDefault(_achievement);

var _restart = __webpack_require__(44);
...
var Modal = function (_React$Component) {
    ...
    _createClass(Modal, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'modal ' + (modal ? 'modal-show' : '') },
                _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(_achievement2.default, { score: score, bestScore: bestScore }),
                        _react2.default.createElement(
                            'button',
                            { className: 'restart-button', onClick: restart },
                            ' ',
                            _react2.default.createElement(
                                'div',
...
var Achievement = function (_React$Component) {
    ...
    function Achievement() {
        ...
        return _possibleConstructorReturn(this, (Achievement.__proto__ || Object.getPrototypeOf(Achievement)).call(this));
    }
...
var Restart = function (_React$Component) {
    _inherits(Restart, _React$Component);

    function Restart() {
        _classCallCheck(this, Restart);

        return _possibleConstructorReturn(this, (Restart.__proto__ || Object.getPrototypeOf(Restart)).call(this));
    }
    ...
    _createClass(Restart, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                { className: "restart" },
                _react2.default.createElement("img", { src: "img/restart.png", alt: "", className: "icon-small" })
            );
        }
    }]);
